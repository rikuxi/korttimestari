...
const I18N_CATALOGS = {
        ...
        'sim.stat.hilo': 'Hi / Lo:',
        'sim.lowLineEmpty': 'Low tehty: – · Low voitettu: – · Ei low\'ta: –',
        'sim.lowLine': 'Low tehty: {made} % · Low voitettu: {won} % · Ei low\'ta: {nolow} %',
        'sim.folded': 'Folded',
    ...
    en: {
        ...
        'sim.stat.hilo': 'Hi / Lo:',
        'sim.lowLineEmpty': 'Low made: – · Low won: – · No low: –',
        'sim.lowLine': 'Low made: {made} % · Low won: {won} % · No low: {nolow} %',
        'sim.folded': 'Folded',
